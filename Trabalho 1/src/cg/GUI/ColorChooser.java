...
public class ColorChooser extends javax.swing.JPanel {
	...
	private static final long serialVersionUID = -5278263257686775736L;

	private final class JPanelExtension extends JPanel 
	{
		private static final long serialVersionUID = -7834725565116060271L;
		private final Color color;
		
		private JPanelExtension(Color color) {
			this.color = color;
		}
    ...
    cbColors.setRenderer( new ListCellRenderer() {
      public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        JPanel pnlColor = new JPanelExtension(color);
